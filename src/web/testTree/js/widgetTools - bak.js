  ...
  (function($) {
      ...
      var widegets = function(options) {
          ...
          widegetMap.searchCombox = function() {
              ...
              function toggleMenu(event) {
                  ...
                  var isSwitch = (($(event.target).parents(classMap.s.zTreeContent).length > 0) || ($(event.target).parents(classMap.s.selectionChoice).length > 0));
                  if (isSwitch) {
                      return false;
                  }
